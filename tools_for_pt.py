...
# sort by name
  ...
  nbrTensors=writeTensors(AllTensors, CommentKey, Domains, Usage,commentE3=commentE3)

  # Write out the equation for A.p
  nbrEqs=WriteCodeSimple(result, AllTensors, CommentKey,commentE3=commentE3)
